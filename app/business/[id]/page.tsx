...
export default function BusinessDetailPage({
	...
	const business = {
		...
		details: {
			...
			realEstate: "Leased",
			leaseTerms:
				"10-year lease with 5 years remaining, MAD 25,000/month",
			inventory:
				"Included in asking price (valued at approximately MAD 350,000)",
			...
			competition:
				"Moderate competition in the area, but established customer base",
			growthOpportunities:
				"Potential for expanded hours, catering services, and delivery options",
		},
		financials: {
			yearlyRevenue: [
				...
				<div className="flex flex-col md:flex-row justify-between items-start gap-6">
					...
					<div className="w-full md:w-2/3 space-y-6">
						...
						<nav className="flex text-sm text-muted-foreground mb-2">
							...
							<span className="mx-2">/</span>
							<Link
								href="/buy-business?industry=food"
								className="hover:text-foreground"
							>
								Food & Beverage
							</Link>
						...
						<div>
							<div className="flex items-center gap-2 mb-2">
								<Badge className="bg-finance-600 hover:bg-finance-700">
									Featured
								</Badge>
						...
						<div className="relative rounded-lg overflow-hidden h-[400px] group">
							<img
								src={
									business.images[currentImageIndex] ||
									"/placeholder.svg"
								}
								alt={business.title}
						...
						<Tabs defaultValue="overview" className="w-full">
										...
										<div className="flex items-start gap-3">
											...
											<div className="text-sm text-muted-foreground">
												...
												<p>
													...
													additional details will only
													be shared after signing a
													non-disclosure agreement.
													Contact the seller to
							...
							>
								<div className="space-y-4">
									...
									<p className="text-muted-foreground">
										{business.details.growthOpportunities}
									</p>
								</div>
							</TabsContent>
								...
								<div className="space-y-4">
									...
									<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
										<Card className="border-border/60 shadow-card">
											...
											<CardContent>
												<div className="space-y-2">
													{business.financials.yearlyRevenue.map(
														(item) => (
															<div
																key={item.year}
										...
										<Card className="border-border/60 shadow-card">
											...
											<CardContent>
												<div className="space-y-2">
													{business.financials.yearlyProfit.map(
														(item) => (
															<div
																key={item.year}
																className="flex justify-between items-center"
									...
									<h2 className="text-xl font-semibold mt-2">
										Annual Expenses (2023)
									</h2>
									<Card className="border-border/60 shadow-card">
										<CardContent className="p-6">
											<div className="grid grid-cols-2 md:grid-cols-3 gap-4">
												{Object.entries(
													business.financials.expenses
												).map(([key, value]) => (
													<div
														key={key}
														className="space-y-1"
							...
							>
								<div className="space-y-4">
									...
									<p className="text-muted-foreground">
										This business is located in a prime area
										of Marrakech, known for high tourist
										traffic and local popularity. The exact
										address will be disclosed to qualified
										buyers after signing an NDA.
									</p>
					...
					<div className="w-full md:w-1/3 space-y-6">
						...
						<Card className="border-border/60 shadow-card sticky top-24">
							<CardHeader>
								<CardTitle className="text-2xl text-finance-600">
									{business.price}
								</CardTitle>
							...
							<CardContent className="space-y-4">
								<div className="flex items-center justify-between">
									...
									<div className="text-right">
										<div className="flex items-center text-xs text-muted-foreground">
											...
											<span>
												{business.seller.responseTime}
											</span>
										</div>
										<p className="text-xs text-muted-foreground">
											{business.seller.responseRate}{" "}
											response rate
										</p>
									</div>
								</div>
								...
								<div className="space-y-2">
									...
									<p className="text-sm text-muted-foreground">
										Interested in this business? Contact the
										seller to:
									</p>
									<ul className="space-y-1 text-sm text-muted-foreground">
										...
										<li className="flex items-start gap-2">
											<CircleDollarSign className="h-4 w-4 mt-0.5 flex-shrink-0" />
											<span>Discuss price and terms</span>
										</li>
									</ul>
								</div>
							</CardContent>
